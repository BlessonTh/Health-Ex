        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-lg-6 text-center text-lg-right content">
              <h1>Contact</h1>
              <p>
                Contact the developers of Health Adda site.
                Remember we are just one click away.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="card border-0 mb-3">
                <div className="card-body p-4">
                  <div className="d-flex">
                    ...
                    <div className="pl-3">
                      <p>Email Address</p>
                      <small>vivek.kumarsahu2020@vitbhopal.ac.in</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card border-0 mb-3">
                <div className="card-body p-4">
                  <div className="d-flex">
                    ...
                    <div className="pl-3">
                      <p>Location</p>
                      <small>Vit Bhopal, Madhya Pradesh, India</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card border-0">
                <div className="card-header border-0 bg-white p-4 pb-0">
                  ...
                  <p className="text-muted mb-0">
                    If you have any queries, fill the form with correct information and push submit button. We will get in touch soon.{" "}
                  </p>
                </div>
                <div className="card-body p-4">
